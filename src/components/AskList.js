...
function mapStateToProps({ questions, users }, { user }) {
    ...
    return {
        answeredQuestionList: answeredQuestionList.sort((a, b) => b.timestamp - a.timestamp),
        unansweredQuestionList: unansweredQuestionList.sort((a, b) => b.timestamp - a.timestamp),
        users
    }
}
